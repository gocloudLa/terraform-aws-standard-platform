...
module "wrapper_ecs_service" {
  source  = "git::https://github.com/gocloudLa/terraform-aws-wrapper-ecs-service.git?ref=feature/add-custom-security-group-rules" #"gocloudLa/wrapper-ecs-service/aws"
  # version = "1.3.0"
